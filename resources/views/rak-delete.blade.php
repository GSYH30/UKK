...
<head>
    ...
    <link rel="stylesheet" href="../css/rak-delete.css">
                ...
                <div class="background">
                    ...
                    <header>
                        ...
                        <ul class="navbar">
                            ...
                            <li><a href="rak-delete" class="active">Delete</a></li>
                        </ul>
                        <div class="nav-user">
                        ...
                        <div class="buku">
                            <div class="image-container">
                                ...
                                <form action="/bukus/{{$buku->id}}" method="POST">
                                    @method('DELETE')
                                    @csrf
                                    <button class="beli-btn">Delete <i class="fa-solid fa-trash"></i></button>
                                </form>
                            </div>
                        </div>
                        @endforeach
