...
<head>
    ...
    <title>Notif Admin</title>
    <link rel="stylesheet" href="../css/notif-admin.css" />
        ...
        <div class="dalam-container">
            <div class="rgb">
                <div class="background">
                    ...
                    <br />
                    <h1>ADMIN AREA</h1>
                    <label for="admin-link">Password Needed</label>
                    <a id="admin-link" href="notif-admin-login">Check In</a>
